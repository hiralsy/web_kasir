    ...
    <div className="w-[250px] h-screen bg-[#0A6847]/50 fixed ">
      ...
      <ul className=" cursor-pointer ml-[5px] mr-[5px]">
        <li className="h-[45px] mb-[5px] ">
          <NavLink href="/beranda" className="h-[45px] pl-[15px] flex items-center mb-[5px] rounded-[10px] hover:bg-[#0A6847] [&.active]:bg-[#0A6847]"> 
          <div className="  ">
            <svg
        ...
        <li className=" h-[45px] mb-[5px] ">
        <NavLink href="/transaksi" className="h-[45px] pl-[15px] flex items-center mb-[5px] rounded-[10px] hover:bg-[#0A6847] [&.active]:bg-[#0A6847]"> 
          <div className=" ">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="32"
        ...
        <li className="flex h-[45px] pl-[15px] items-center mb-[5px] rounded-[10px] hover:bg-[#0A6847] ">
          <div className=" ">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="32"
