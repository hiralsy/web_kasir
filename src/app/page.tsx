  ...
  return (
    <div className="w-screen h-screen pt-[120px] pl-[280px] bg-[#F5F7F8]">
      <div className="w-[1000px] h-[500px] flex rounded-[20px] pt-[25px] pl-[50px] bg-[#0A6847] shadow-md">
        ...
        <div className="w-[400px] h-[400px] mt-[25px] ml-[50px] rounded-[10px] bg-[#F5F7F8]">
          <div className="">
            <Image
              src={"/caisse.png"}
          ...
          <div className="flex w-[400px] h-[50px] items-center pl-[50px] mt-[30px] ">
            <svg
              ...
              fill="#000000"
              viewBox="0 0 256 256"
              className="pointer-events-none absolute fill-[#0A6847] mt-1 mb-1 ml-3"
            >
            ...
            <input
              ...
              className="w-[300px] h-[40px] pl-[45px] pr-3 rounded-[10px] bg-[#0A6847]/10 text-[16px] outline-[#0A6847]"
            ></input>
          </div>
          ...
          <div className="flex w-[400px] h-[50px] items-center pl-[50px] mt-[10px] ">
            ...
            <input
              ...
              className="w-[300px] h-[40px] pl-[45px] pr-3 rounded-[10px] text-[16px] bg-[#0A6847]/10 outline-[#0A6847] "
              id="password"
            ></input>
          </div>
